...
export default function PortfolioHeroSection() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/port-hero-3.jpg')",
      ...
      <div className='relative z-30 h-full flex flex-col items-center justify-center px-4 md:px-8 lg:px-16'>
        ...
        >
          ...
          <h1 className='text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 tracking-tight leading-tight animate-fade-in'>
            Our Finest
            <span className='text-[#f74401]'> Projects</span>
          </h1>

          {/* Subheading with Animation */}
          <p className='text-lg md:text-xl text-gray-100 mb-10 max-w-3xl mx-auto leading-relaxed animate-fade-in-delayed'>
            Explore our portfolio showcasing excellence in construction. From
            residential masterpieces to commercial landmarks, our work reflects
            our commitment to quality, innovation, and craftsmanship.
          </p>
          ...
          >
            <span className='flex items-center'>View Our Projects</span>
          </a>
        </div>
